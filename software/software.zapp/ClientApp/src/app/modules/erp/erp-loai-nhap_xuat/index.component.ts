...
import { erp_loai_nhap_xuat_popupAddComponent } from './popupAdd.component';
...
@Component({
    selector: 'erp_loai_nhap_xuat_index',
    templateUrl: './index.component.html',
    styleUrls: ['./index.component.scss'],
})
export class erp_loai_nhap_xuat_indexComponent extends BaseIndexDatatableComponent {
    ...
    openDialogAdd() {
        const dialog = this.dialog.open(erp_loai_nhap_xuat_popupAddComponent, {
            disableClose: true,
            width: '768px',
            data: {
                actionEnum: 1,
    ...
    ngOnInit() {
        var title =
            'CuaSneaker - ' +
            this.translocoService.translate('NAV.erp_loai_nhap_xuat');
        var metaTag = [
            {
                property: 'og:url',
