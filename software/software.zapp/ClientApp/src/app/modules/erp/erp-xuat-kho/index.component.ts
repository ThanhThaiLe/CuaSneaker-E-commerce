...
import { erp_xuat_kho_popupAddComponent } from './popupAdd.component';
...
@Component({
    selector: 'erp_xuat_kho_index',
    templateUrl: './index.component.html',
    styleUrls: ['./index.component.scss'],
})
export class erp_xuat_kho_indexComponent extends BaseIndexDatatableComponent {
    ...
    openDialogAdd() {
        const dialog = this.dialog.open(erp_xuat_kho_popupAddComponent, {
            disableClose: true,
            width: '768px',
            data: {
                actionEnum: 1,
    ...
    ngOnInit() {
        var title =
            'CuaSneaker - ' +
            this.translocoService.translate('NAV.erp_xuat_kho');
        var metaTag = [
            {
                property: 'og:url',
