...
import { sys_vat_popupAddComponent } from './popupAdd.component';
...
@Component({
    selector: 'sys_vat_index',
    templateUrl: './index.component.html',
    styleUrls: ['./index.component.scss'],
})
export class sys_vat_indexComponent extends BaseIndexDatatableComponent {
    ...
    openDialogAdd() {
        const dialog = this.dialog.open(sys_vat_popupAddComponent, {
            disableClose: true,
            width: '768px',
            data: {
                actionEnum: 1,
    ...
    ngOnInit() {
        var title =
            'CuaSneaker - ' + this.translocoService.translate('NAV.sys_vat');
        var metaTag = [
            {
                property: 'og:url',
