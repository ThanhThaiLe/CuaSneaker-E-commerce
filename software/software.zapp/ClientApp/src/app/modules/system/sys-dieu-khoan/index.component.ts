...
import { sys_dieu_khoan_popupAddComponent } from './popupAdd.component';
...
@Component({
    selector: 'sys_dieu_khoan_index',
    templateUrl: './index.component.html',
    styleUrls: ['./index.component.scss'],
})
export class sys_dieu_khoan_indexComponent extends BaseIndexDatatableComponent {
    ...
    openDialogAdd() {
        const dialog = this.dialog.open(sys_dieu_khoan_popupAddComponent, {
            disableClose: true,
            width: '768px',
            data: {
                actionEnum: 1,
    ...
    ngOnInit() {
        var title =
            'CuaSneaker - ' +
            this.translocoService.translate('NAV.sys_dieu_khoan');
        var metaTag = [
            {
                property: 'og:url',
