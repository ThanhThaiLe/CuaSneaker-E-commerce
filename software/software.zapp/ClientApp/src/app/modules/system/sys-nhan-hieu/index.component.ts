...
import { sys_nhan_hieu_popupAddComponent } from './popupAdd.component';
...
@Component({
    selector: 'sys_nhan_hieu_index',
    templateUrl: './index.component.html',
    styleUrls: ['./index.component.scss'],
})
export class sys_nhan_hieu_indexComponent extends BaseIndexDatatableComponent {
    ...
    openDialogAdd() {
        const dialog = this.dialog.open(sys_nhan_hieu_popupAddComponent, {
            disableClose: true,
            width: '768px',
            data: {
                actionEnum: 1,
    ...
    ngOnInit() {
        var title =
            'CuaSneaker - ' +
            this.translocoService.translate('NAV.sys_nhan_hieu');
        var metaTag = [
            {
                property: 'og:url',
