...
import { sys_quoc_gia_popupAddComponent } from './popupAdd.component';
...
@Component({
    selector: 'sys_quoc_gia_index',
    templateUrl: './index.component.html',
    styleUrls: ['./index.component.scss'],
})
export class sys_quoc_gia_indexComponent extends BaseIndexDatatableComponent {
    ...
    openDialogAdd() {
        const dialog = this.dialog.open(sys_quoc_gia_popupAddComponent, {
            disableClose: true,
            width: '768px',
            data: {
                actionEnum: 1,
    ...
    ngOnInit() {
        var title =
            'CuaSneaker - ' +
            this.translocoService.translate('NAV.sys_quoc_gia');
        var metaTag = [
            {
                property: 'og:url',
