...
import { sys_ngan_hang_popupAddComponent } from './popupAdd.component';
...
@Component({
    selector: 'sys_ngan_hang_index',
    templateUrl: './index.component.html',
    styleUrls: ['./index.component.scss'],
})
export class sys_ngan_hang_indexComponent extends BaseIndexDatatableComponent {
    ...
    openDialogAdd() {
        const dialog = this.dialog.open(sys_ngan_hang_popupAddComponent, {
            disableClose: true,
            width: '768px',
            data: {
                actionEnum: 1,
    ...
    ngOnInit() {
        var title =
            'CuaSneaker - ' +
            this.translocoService.translate('NAV.sys_ngan_hang');
        var metaTag = [
            {
                property: 'og:url',
