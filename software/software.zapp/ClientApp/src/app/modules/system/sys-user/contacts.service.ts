...
export class ContactsService {
    ...
    getContacts(): Observable<Contact[]> {
        return this._httpClient
            .get<Contact[]>('sys_khach_hang.ctr/getContacts')
            .pipe(
                tap((contacts) => {
    ...
    createContact(): Observable<Contact> {
        return this.contacts$.pipe(
            ...
            switchMap((contacts) =>
                this._httpClient
                    .post<Contact>('sys_khach_hang.ctr/initeData', {})
                    .pipe(
                        map((newContact) => {
    ...
    getTags(): Observable<Tag[]> {
        return this._httpClient.get<Tag[]>('sys_tag_user.ctr/getListUse').pipe(
            tap((tags) => {
    ...
    createTag(tag: Tag): Observable<Tag> {
        return this.tags$.pipe(
            ...
            switchMap((tags) =>
                this._httpClient
                    .post<Tag>('sys_tag_user.ctr/create', { data: tag })
                    .pipe(
                        map((newTag) => {
    ...
    updateTag(id: string, tag: Tag): Observable<Tag> {
        return this.tags$.pipe(
            ...
            switchMap((tags) =>
                this._httpClient
                    .patch<Tag>('sys_tag_user.ctr/update', {
                        id,
                        tag,
                    })
                    .pipe(
    ...
    deleteTag(id: string): Observable<boolean> {
        return this.tags$.pipe(
            ...
            switchMap((tags) =>
                this._httpClient
                    .delete('sys_tag_user.ctr/update_status', {
                        params: { id },
                    })
                    .pipe(
                        map((isDeleted: boolean) => {
