...
@Component({
    selector: 'app-data-buy-products',
    templateUrl: './data-buy-products.component.html',
    styleUrls: ['./data-buy-products.component.scss'],
})
export class DataBuyProductsComponent implements OnInit {
