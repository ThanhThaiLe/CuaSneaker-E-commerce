...
{
    public class sys_color_configuration : IEntityTypeConfiguration<sys_color_db>
    {
        public void Configure(EntityTypeBuilder<sys_color_db> builder)
        {
            builder.ToTable("sys_color", "dbo");
