...
{
    public class sys_nha_cung_cap_configuration : IEntityTypeConfiguration<sys_nha_cung_cap_db>
    {
        public void Configure(EntityTypeBuilder<sys_nha_cung_cap_db> builder)
        {
            builder.ToTable("sys_nha_cung_cap", "dbo");

            builder.Property(x => x.code).HasMaxLength(10).IsRequired();
            builder.HasIndex(x => x.code).IsUnique();
            builder.Property(x => x.name).HasMaxLength(128).IsRequired();
            builder.Property(x => x.hinh_thuc).HasDefaultValueSql("1");
            ...
            builder.Property(x => x.update_by).HasMaxLength(128);
