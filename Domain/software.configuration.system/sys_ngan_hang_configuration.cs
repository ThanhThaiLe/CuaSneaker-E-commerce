...
{
    public class sys_ngan_hang_configuration : IEntityTypeConfiguration<sys_ngan_hang_db>
    {
        public void Configure(EntityTypeBuilder<sys_ngan_hang_db> builder)
        {
            builder.ToTable("sys_ngan_hang", "dbo");
            ...
            builder.Property(x => x.so_tai_khoan).HasMaxLength(128).IsRequired();
