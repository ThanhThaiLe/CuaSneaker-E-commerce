...
{
    public class sys_don_vi_tinh_configuration : IEntityTypeConfiguration<sys_don_vi_tinh_db>
    {
        public void Configure(EntityTypeBuilder<sys_don_vi_tinh_db> builder)
        {
            builder.ToTable("sys_don_vi_tinh", "dbo");
