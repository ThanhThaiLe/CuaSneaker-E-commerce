...
{
    public class erp_nhap_kho_configuration : IEntityTypeConfiguration<erp_nhap_kho_db>
    {
        public void Configure(EntityTypeBuilder<erp_nhap_kho_db> builder)
        {
            builder.ToTable("erp_nhap_kho", "dbo");
