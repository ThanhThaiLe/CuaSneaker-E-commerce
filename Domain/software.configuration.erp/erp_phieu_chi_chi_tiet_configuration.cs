...
{
    public class erp_phieu_chi_chi_tiet_configuration : IEntityTypeConfiguration<erp_phieu_chi_chi_tiet_db>
    {
        public void Configure(EntityTypeBuilder<erp_phieu_chi_chi_tiet_db> builder)
        {
            builder.ToTable("erp_phieu_chi_chi_tiet", "dbo");

            builder.Property(x => x.id_phieu_chi).IsRequired();
            ...
            builder.Property(x => x.ngay_chi).HasDefaultValueSql("getutcdate()");
