...
{
    public class erp_don_hang_ban_configuration : IEntityTypeConfiguration<erp_don_hang_ban_db>
    {
        public void Configure(EntityTypeBuilder<erp_don_hang_ban_db> builder)
        {
            builder.ToTable("erp_don_hang_ban", "dbo");
