...
{
    public class erp_don_hang_ban_chi_tiet_configuration : IEntityTypeConfiguration<erp_don_hang_ban_chi_tiet_db>
    {
        public void Configure(EntityTypeBuilder<erp_don_hang_ban_chi_tiet_db> builder)
        {
            builder.ToTable("erp_don_hang_ban_chi_tiet", "dbo");


            builder.Property(q => q.id_don_hang).IsRequired();
            builder.Property(q => q.id_san_pham).IsRequired();
            builder.Property(q => q.ten_san_pham).IsRequired();
            builder.Property(q => q.ma_san_pham).IsRequired();
            builder.Property(q => q.id_nhan_hieu).IsRequired();
            builder.Property(q => q.id_size).IsRequired();
            builder.Property(q => q.id_color).IsRequired();
