...
export class NotificationsComponent implements OnChanges, OnInit, OnDestroy {
    ...
    constructor(
        ...
        this._notificationsService.data$.subscribe((newData) => {
            this.unreadCount = newData;
            this._changeDetectorRef.markForCheck();
        });
    }

    updateData(): void {
        this._notificationsService.updateData(this.unreadCount);
    }
    load_more() {
    ...
    count_luot_xem(id_thong_bao) {
        this.http
            .post('/sys_quan_ly_thong_bao.ctr/change_check_xem', {
    ...
    load_thong_bao(is_load_more): void {
        if (is_load_more) {
            this.http
                .post('/sys_quan_ly_thong_bao.ctr/get_list_notification_web', {
                    start: this.start,
                })
                .subscribe((resp) => {
                    var data: any = [];
    ...
    update_thong_bao_all(): void {
        this.http
            .post('/sys_quan_ly_thong_bao.ctr/update_thong_bao_all', {})
            .subscribe((resp) => {
    ...
    update_thong_bao(id, status, link): void {
        this.http
            .post('/sys_quan_ly_thong_bao_nhan_su.ctr/update_thong_bao/', {
                id: id,
                status: status,
                link: link,
            })
    ...
    update_view_tbns(id) {
        this.http
            .post('/sys_quan_ly_thong_bao_nhan_su.ctr/update_view_tbns', {
                id: id,
            })
            .subscribe((resp) => {});
    }
    delete_thong_bao(id): void {
        this.http
            .post('/sys_quan_ly_thong_bao.ctr/delete_thong_bao/', {
                id: id,
            })
            .subscribe((resp) => {
                this.load_thong_bao(false);
