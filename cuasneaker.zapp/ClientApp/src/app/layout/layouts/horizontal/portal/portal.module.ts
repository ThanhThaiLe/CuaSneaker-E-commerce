...
import { portalLayoutComponent } from 'app/layout/layouts/horizontal/portal/portal.component';
import { ShoppingCardsModule } from 'app/layout/common/products-card/products-card.module';
