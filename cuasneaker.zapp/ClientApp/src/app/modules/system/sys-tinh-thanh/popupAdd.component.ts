...
import { sys_tinh_thanh_model } from './sys-tinh-thanh.types';
...
export class sys_tinh_thanh_popupAddComponent extends BasePopUpAddTypeComponent<sys_tinh_thanh_model> {
    ...
    constructor(
        ...
        public dialogRef: MatDialogRef<sys_tinh_thanh_popupAddComponent>,
