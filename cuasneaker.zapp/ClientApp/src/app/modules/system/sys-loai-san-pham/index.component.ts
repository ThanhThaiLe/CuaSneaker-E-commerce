...
import { sys_loai_san_pham_popupAddComponent } from './popupAdd.component';
...
@Component({
    selector: 'sys_loai_san_pham_index',
    templateUrl: './index.component.html',
    styleUrls: ['./index.component.scss'],
})
export class sys_loai_san_pham_indexComponent extends BaseIndexDatatableComponent {
    ...
    openDialogAdd() {
        const dialog = this.dialog.open(sys_loai_san_pham_popupAddComponent, {
            disableClose: true,
            width: '768px',
            data: {
                actionEnum: 1,
    ...
    ngOnInit() {
        var title =
            'CuaSneaker - ' +
            this.translocoService.translate('NAV.sys_loai_san_pham');
        var metaTag = [
            {
                property: 'og:url',
