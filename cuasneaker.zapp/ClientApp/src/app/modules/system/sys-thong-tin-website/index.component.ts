...
import { sys_thong_tin_website_popupAddComponent } from './popupAdd.component';
...
@Component({
    selector: 'sys_thong_tin_website_index',
    templateUrl: './index.component.html',
    styleUrls: ['./index.component.scss'],
})
export class sys_thong_tin_website_indexComponent extends BaseIndexDatatableComponent {
    ...
    ngOnInit() {
        var title =
            'CuaSneaker - ' +
            this.translocoService.translate('NAV.sys_thong_tin_website');
        var metaTag = [
            {
                property: 'og:url',
