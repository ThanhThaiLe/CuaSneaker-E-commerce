...
import { sys_lien_ket_popupAddComponent } from './popupAdd.component';
...
@Component({
    selector: 'sys_lien_ket_index',
    templateUrl: './index.component.html',
    styleUrls: ['./index.component.scss'],
})
export class sys_lien_ket_indexComponent extends BaseIndexDatatableComponent {
    ...
    openDialogAdd() {
        const dialog = this.dialog.open(sys_lien_ket_popupAddComponent, {
            disableClose: true,
            width: '768px',
            data: {
                actionEnum: 1,
    ...
    ngOnInit() {
        var title =
            'CuaSneaker - ' +
            this.translocoService.translate('NAV.sys_lien_ket');
        var metaTag = [
            {
                property: 'og:url',
