...
import { sys_type_mail_popupAddComponent } from './popupAdd.component';
...
@Component({
    selector: 'sys_type_mail_index',
    templateUrl: './index.component.html',
    styleUrls: ['./index.component.scss'],
})
export class sys_type_mail_indexComponent extends BaseIndexDatatableComponent {
    ...
    openDialogAdd() {
        const dialog = this.dialog.open(sys_type_mail_popupAddComponent, {
            disableClose: true,
            width: '768px',
            data: {
                actionEnum: 1,
    ...
    ngOnInit() {
        var title =
            'CuaSneaker - ' +
            this.translocoService.translate('NAV.sys_type_mail');
        var metaTag = [
            {
                property: 'og:url',
