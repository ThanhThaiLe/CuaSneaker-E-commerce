...
import { erp_don_hang_ban_popupAddComponent } from './popupAdd.component';
...
@Component({
    selector: 'erp_don_hang_ban_index',
    templateUrl: './index.component.html',
    styleUrls: ['./index.component.scss'],
})
export class erp_don_hang_ban_indexComponent extends BaseIndexDatatableComponent {
    ...
    openDialogAdd() {
        const dialog = this.dialog.open(erp_don_hang_ban_popupAddComponent, {
            disableClose: true,
            width: '80%',
            data: {
                actionEnum: 1,
    ...
    ngOnInit() {
        var title =
            'CuaSneaker - ' +
            this.translocoService.translate('NAV.erp_don_hang_ban');
        var metaTag = [
            {
                property: 'og:url',
