...
export class cm_file_upload_popupComponent extends BasePopupDatatabbleComponent {
    public record: any;
    constructor(
        public dialogRef: MatDialogRef<cm_file_upload_popupComponent>,
    ...
    get_list_file() {
        this.http
            .post('sys_file_upload.ctr/get_list_file', {
                id_parent: this.filter.id_parent,
